...
const testimonials = [
  ...
  {
    text: "У нас двое детей и кот, диван был в пятнах. Вызвали Белый Кит, мастер приехал точно вовремя, все объяснил, почистил. Средства безопасные, запаха нет. Через 3 часа уже сидели на диване. Супер!",
