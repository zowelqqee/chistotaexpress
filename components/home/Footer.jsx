    ...
    <footer className={styles.footer} id="contacts">
      <div className={`container ${styles.inner}`}>
        <div className={styles.brand}>
          <a href="#" className={styles.logo}>
            <span className={styles.logoMark}>NS</span>
            <span className={styles.logoText}>
              <span className={styles.logoMain}>Non-Stop</span>
              <span className={styles.logoSub}>Premium Cleaning</span>
            </span>
          </a>
          <p className={styles.brandDesc}>
            Профессиональный клининг в Ереване.<br />
            Квартиры, офисы, после ремонта.
          </p>
        </div>
        ...
        <div className={styles.contacts}>
          ...
          <ul className={styles.contactList}>
            <li>
              <a href="tel:+37493111772" className={styles.contactItem}>
            ...
            <li>
              <a href="https://wa.me/37444410861" target="_blank" rel="noopener noreferrer" className={styles.contactItem}>
            ...
            <li>
              <a href="https://t.me/nonstopclean" target="_blank" rel="noopener noreferrer" className={styles.contactItem}>
                <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div className={styles.bottom}>
        <div className="container">
          <p className={styles.copy}>© {new Date().getFullYear()} Non-Stop Premium Cleaning. Ереван.</p>
        </div>
      </div>
    </footer>
  )
